                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div style="padding: 0 10px;text-align:justify"> 
                            ...
                            <p><i style="margin-right:10px" class="fa fa-map-marker"></i>Tacna - Peru</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
                            <p><i style="margin-right:10px" class="fa fa-phone"></i>+51 952 974 805</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
                            <p><i style="margin-right:10px" class="fa fa-envelope"></i>digrafpublicidad11@gmail.com</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
                            <p><i style="margin-right:10px" class="fa fa-home"></i>Ubícanos en: Fermin Nacarino N° 744 / 782</p>
                        </div>
                    </div>
                </div>
            </div>
